  ...
  return (
    <section className="min-h-screen bg-gray-50 py-20 px-6">
      ...
      <div className="relative w-full h-64 md:h-96 mb-12 flex items-center justify-center rounded-xl overflow-hidden">
        ...
        />
        <div className="absolute w-full h-full bg-gradient-to-b from-orange-400/60 via-orange-300/40 to-transparent"></div>
    ...
    <div className="max-w-6xl mx-auto mt-24 p-10 rounded-3xl bg-gradient-to-r from-orange-50 to-white shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200">
